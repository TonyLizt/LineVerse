...
| 姓名 | GitHub | 主要负责内容 |
|---|---|---|
| 李泽同 | [TonyLizt](https://github.com/TonyLizt) | 组长；成语接龙模块；整体架构设计与项目整合 |
| 刘懋兴 | [me-teor](https://github.com/me-teor) | 汉兜模块；中文输入、拼音特征判定与界面交互 |
| 何明涛 | [Mint221018](https://github.com/Mint221018) | 诗词描述猜测模块；题库、提示、候选集过滤与判题 |
