...
// /**
//  * @brief SDL-based presentation scene for the idiom-chain game module.
//  *
//  * This version uses a desktop-oriented multi-page layout:
//  * - Main menu
...
//  * - Leaderboard page
//  *
//  * All game rules, validation, path solving and persistence still stay inside
//  * IdiomChainController. The scene only renders and forwards user actions.
//  */
...
//     /**
//      * @brief Run the scene loop.
//      * @return 0 to exit application, 1 to return main menu, -1 on error.
//      */
//     int run();
